...
if __name__ == '__main__':
    ...
    algorithms = [#Algorithm(s=50, k=[3, 5, 7], t=0.8, aggregation=A1Aggregation(), random_state=seed, n_jobs=-1),
        ...
        Algorithm(s=20, k=[1], t=0.5, aggregation=A1Aggregation(), random_state=seed, n_jobs=-1),
        Algorithm(s=20, k=[1], t=0.5, aggregation=A2Aggregation(), random_state=seed, n_jobs=-1),
        Algorithm(s=20, k=[1], t=0.5, aggregation=A3Aggregation(), random_state=seed, n_jobs=-1),
        Algorithm(s=20, k=[1], t=0.5, aggregation=A6Aggregation(), random_state=seed, n_jobs=-1),
        Algorithm(s=20, k=[1], t=0.5, aggregation=A10Aggregation(), random_state=seed, n_jobs=-1),
...
print(fin_res)
fin_res.to_excel('RESULTS_ovarian.xlsx')