...
from __settings import s_list, datasets
...
if __name__ == '__main__':
    for dataset in datasets:
        ...
        for (train_index, test_index) in cv.split(X=dataset.X, y=dataset.y):
            ...
            rfe = RFE(estimator=SVC(kernel='linear', random_state=seed), step=dataset.rfe_step,
        ...
        print(fin_res)
        fin_res.to_excel(f'{dataset.name}_results_{experiment_version}.xlsx')